...
// The first return arg will be true if a vendor_boot.img bootimg module is autogenerated.
// The second arg is the ramdisk fragments.
func createVendorBootImage(ctx android.LoadHookContext, dtbImg dtbImg) (bool, []string) {
	partitionVariables := ctx.Config().ProductVariables().PartitionVarsForSoongMigrationOnlyDoNotUse
	...
	return true, ramdiskFragmentModules
}

// Same as vendor_boot, with the exception of the ramdisk module.
func createVendorBootDebugImage(ctx android.LoadHookContext, dtbImg dtbImg, ramdiskFragmentModules []string) bool {
	partitionVariables := ctx.Config().ProductVariables().PartitionVarsForSoongMigrationOnlyDoNotUse
...
func createVendorBootTestHarnessImage(ctx android.LoadHookContext, dtbImg dtbImg, ramdiskFragmentModules []string) bool {
	partitionVariables := ctx.Config().ProductVariables().PartitionVarsForSoongMigrationOnlyDoNotUse
