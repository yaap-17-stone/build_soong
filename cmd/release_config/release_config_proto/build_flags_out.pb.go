...
type FlagArtifact struct {
	...
	// Whether this flag has multiple declarations.
	Duplicate *bool `protobuf:"varint,9,opt,name=duplicate" json:"duplicate,omitempty"`
}
...
func (x *FlagArtifact) GetDuplicate() bool {
...
type DuplicateAllowlist struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The path to the duplicate_allowlist.txt file.
	Path *string `protobuf:"bytes,1,opt,name=path" json:"path,omitempty"`
	// The allowed duplicates.
	Allowed []string `protobuf:"bytes,2,rep,name=allowed" json:"allowed,omitempty"`
}

func (x *DuplicateAllowlist) Reset() {
	*x = DuplicateAllowlist{}
	if protoimpl.UnsafeEnabled {
		mi := &file_build_flags_out_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *DuplicateAllowlist) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DuplicateAllowlist) ProtoMessage() {}

func (x *DuplicateAllowlist) ProtoReflect() protoreflect.Message {
	mi := &file_build_flags_out_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DuplicateAllowlist.ProtoReflect.Descriptor instead.
func (*DuplicateAllowlist) Descriptor() ([]byte, []int) {
	return file_build_flags_out_proto_rawDescGZIP(), []int{5}
}

func (x *DuplicateAllowlist) GetPath() string {
	if x != nil && x.Path != nil {
		return *x.Path
	}
	return ""
...
func (x *DuplicateAllowlist) GetAllowed() []string {
	if x != nil {
		return x.Allowed
	}
	return nil
...
type DuplicateFlagsArtifact struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// All flags declared.
	// key: flag name, value: FlagArtifact
	FlagArtifactMap map[string]*FlagArtifact `protobuf:"bytes,1,rep,name=flag_artifact_map,json=flagArtifactMap" json:"flag_artifact_map,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// Contents of duplicate_allowlist.txt files.
	DuplicateAllowlists []*DuplicateAllowlist `protobuf:"bytes,2,rep,name=duplicate_allowlists,json=duplicateAllowlists" json:"duplicate_allowlists,omitempty"`
}

func (x *DuplicateFlagsArtifact) Reset() {
	*x = DuplicateFlagsArtifact{}
	if protoimpl.UnsafeEnabled {
		mi := &file_build_flags_out_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *DuplicateFlagsArtifact) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DuplicateFlagsArtifact) ProtoMessage() {}

func (x *DuplicateFlagsArtifact) ProtoReflect() protoreflect.Message {
	mi := &file_build_flags_out_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DuplicateFlagsArtifact.ProtoReflect.Descriptor instead.
func (*DuplicateFlagsArtifact) Descriptor() ([]byte, []int) {
	return file_build_flags_out_proto_rawDescGZIP(), []int{6}
}

func (x *DuplicateFlagsArtifact) GetFlagArtifactMap() map[string]*FlagArtifact {
	if x != nil {
		return x.FlagArtifactMap
	}
	return nil
}

func (x *DuplicateFlagsArtifact) GetDuplicateAllowlists() []*DuplicateAllowlist {
	if x != nil {
		return x.DuplicateAllowlists
	}
	return nil
}
...
var file_build_flags_out_proto_rawDesc = []byte{
	...
	0x6f, 0x2e, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x84,
	0x02, 0x0a, 0x0c, 0x46, 0x6c, 0x61, 0x67, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x12,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_build_flags_out_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_build_flags_out_proto_goTypes = []interface{}{
	...
	(*DuplicateAllowlist)(nil),     // 5: android.release_config_proto.DuplicateAllowlist
	(*DuplicateFlagsArtifact)(nil), // 6: android.release_config_proto.DuplicateFlagsArtifact
	nil,                            // 7: android.release_config_proto.ReleaseConfigsArtifact.ReleaseConfigMapsMapEntry
	nil,                            // 8: android.release_config_proto.DuplicateFlagsArtifact.FlagArtifactMapEntry
	(*Value)(nil),                  // 9: android.release_config_proto.Value
	(*FlagDeclaration)(nil),        // 10: android.release_config_proto.FlagDeclaration
	(ReleaseConfigType)(0),         // 11: android.release_config_proto.ReleaseConfigType
	(*ReleaseConfigMap)(nil),       // 12: android.release_config_proto.ReleaseConfigMap
}
var file_build_flags_out_proto_depIdxs = []int32{
	9,  // 0: android.release_config_proto.Tracepoint.value:type_name -> android.release_config_proto.Value
	10, // 1: android.release_config_proto.FlagArtifact.flag_declaration:type_name -> android.release_config_proto.FlagDeclaration
	9,  // 2: android.release_config_proto.FlagArtifact.value:type_name -> android.release_config_proto.Value
	...
	11, // 6: android.release_config_proto.ReleaseConfigArtifact.release_config_type:type_name -> android.release_config_proto.ReleaseConfigType
	...
	7,  // 9: android.release_config_proto.ReleaseConfigsArtifact.release_config_maps_map:type_name -> android.release_config_proto.ReleaseConfigsArtifact.ReleaseConfigMapsMapEntry
	8,  // 10: android.release_config_proto.DuplicateFlagsArtifact.flag_artifact_map:type_name -> android.release_config_proto.DuplicateFlagsArtifact.FlagArtifactMapEntry
	5,  // 11: android.release_config_proto.DuplicateFlagsArtifact.duplicate_allowlists:type_name -> android.release_config_proto.DuplicateAllowlist
	12, // 12: android.release_config_proto.ReleaseConfigsArtifact.ReleaseConfigMapsMapEntry.value:type_name -> android.release_config_proto.ReleaseConfigMap
	1,  // 13: android.release_config_proto.DuplicateFlagsArtifact.FlagArtifactMapEntry.value:type_name -> android.release_config_proto.FlagArtifact
...
func file_build_flags_out_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_build_flags_out_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DuplicateAllowlist); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_build_flags_out_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DuplicateFlagsArtifact); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
